...
HD_PWD='/home/semi/Project/vivado_rtl/project_1/project_1.runs/design_1_rst_ps7_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_rst_ps7_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_rst_ps7_100M_0.tcl
